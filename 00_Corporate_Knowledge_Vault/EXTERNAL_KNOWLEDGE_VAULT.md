...
| **C++ Concurrency in Action (2nd ed, 2019)**<br/>*(Anthony Williams - Manning)* | Sách chuyên sâu đa luồng | **96 / 100** | 🏆 Tier A+ | **"Kinh thánh Đa luồng C++"**: Kiến trúc Thread Pool, Đồng bộ hóa nâng cao (`std::scoped_lock`, Condition Variables), Atomic Operations và thiết kế cấu trúc dữ liệu không khóa (Lock-Free Data Structures). |
| **atomic<> Weapons: The C++11/20 Memory Model and Hardware**<br/>*(Herb Sutter - CppCon / Microsoft)* | Chuyên khảo học thuật & Video | **94 / 100** | 🏆 Tier A+ | **Bản chất phần cứng & Memory Barriers**: Instruction Reordering của CPU, Cache Coherence (Giao thức MESI), Store Buffers, Phân tích chi tiết `relaxed`, `acquire-release`, và `seq_cst`. |
| **The Art of Multiprocessor Programming (2nd ed, 2020)**<br/>*(Maurice Herlihy, Nir Shavit - Morgan Kaufmann)* | Sách lý thuyết hệ thống | **95 / 100** | 🏆 Tier A+ | **Nguyên lý tính toán song song**: Bất biến đồng thời (Linearizability), Thuật toán đồng thuận (Consensus), Tránh Deadlock/Livelock và các giải thuật chờ tối thiểu (Wait-Free Algorithms). |
